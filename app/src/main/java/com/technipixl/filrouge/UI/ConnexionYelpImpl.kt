...
class ConnexionYelpImpl : RetrofitYelp(){
    ...
    suspend fun getPark( latitude:Double, longitude:Double, limit:Int, term:String ):Response<DataYelp> = getRetrofitYelp().create(ConnexionYelp::class.java).parc(latitude,longitude,limit,term)
}